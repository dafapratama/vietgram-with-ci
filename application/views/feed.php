...
<body>
    ...
    <main id="feed">
        ...
        <div class="photo">
            ...
            <center><img class="img-fluid" height="400px" width="400px" src="assets/images/<?php echo $_SESSION['username']."/".$row[$i]->url; ?>" /></center>
            <div class="photo__info">
                ...
                <span class="photo__likes">543 likes</span>
