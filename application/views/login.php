        ...
        <main id="login">
            ...
            <div class="login__column">
                <div class="login__box">
                    ...
                    <?php } ?>
                    <form action="<?php echo site_url(); ?>login/aksi_login" method="post" class="login__form">
                ...
                <div class="login__box">
                    <span>Don't have an account?</span> <a href="<?= site_url()?>Daftar/index">Sign up</a>
                </div>
                <div class="login__box--transparent">
                    <span>Get the app.</span>
                    <div class="login__appstores">
                        <img src="<?php echo site_url('assets/images/ios.png')?>" class="login__appstore" alt="Apple appstore logo" title="Apple appstore logo" />
